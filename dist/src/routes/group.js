...
import validateGroup, { createGroupSchema, updateGroupSchema, } from "../validation/groupValidation";
...
router.post("/", [verfiyAccessToken, validateBody(validateGroup(createGroupSchema))], group.create);
router.put("/:groupId", [verfiyAccessToken, validateBody(validateGroup(updateGroupSchema))], group.update);
